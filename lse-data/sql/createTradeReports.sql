...
CREATE INDEX id_transactions_time ON transactions(trade_time_stamp, message_sequence_number);
CREATE INDEX id_transactions_publication ON transactions(publication_time_stamp, message_sequence_number);
CREATE INDEX id_transactions_trade_size ON transactions(trade_size);
CREATE INDEX id_transactions_trade_price ON transactions(trade_price) USING HASH;
