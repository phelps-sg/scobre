...
resolvers ++= Seq(
  ...
  "programmers-friend" at "http://programmers-friend.org/maven/repo/",
  "jabm" at "http://jabm.sourceforge.net/mvn-repo/jabm/"
)

libraryDependencies ++= Seq(
  "org.apache.hbase" % "hbase-client" % "1.4.4",
  "org.apache.hbase" % "hbase-common" % "1.4.4" excludeAll ExclusionRule(organization = "javax.servlet"),
  "org.apache.hbase" % "hbase-server" % "1.4.4" excludeAll ExclusionRule(organization = "org.mortbay.jetty"),
